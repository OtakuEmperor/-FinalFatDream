...
function npc2_draw(dialogNum)
    ...
    elseif dialogNum==2 then
        if npc_dialog_state == (question6_dialogLength+1) then
        addKey()
        ...
        if question6_dialog[npc_dialog_namestate] == "nil" then
            question6_dialog[npc_dialog_namestate] = " "
        end
 print_dialog(question6_dialog[npc_dialog_namestate],question6_dialog[npc_dialog_state])
    end
